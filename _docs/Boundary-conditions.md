 ...
 * [The Blender Object and its Material data-blocks](#the-blender-object-and-its-material-data-blocks)
 * [Setting the boundary condition of `OBST` and `VENT` namelists](#setting-the-boundary-condition-of-OBST-and-vent-namelists)
 * [Setting the boundary conditions of `GEOM` namelists](#setting-the-boundary-conditions-of-geom-namelists)
